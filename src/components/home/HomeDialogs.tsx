    ...
    <>
      ...
      >
        <form onSubmit={onSubmitRegister}>
          ...
          <DialogActions sx={{ px: 3, pb: 3.5, pt: 1.5, display: "flex", gap: 1.5 }}> 
            <Button onClick={onCloseRegister} sx={{ borderRadius: 2, fontWeight: "900", textTransform: "none", px: 3, py: 1, border: "1px solid #e2e8f0", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", color: "#1e293b", bgcolor: "white", "&:hover": { bgcolor: "#fdf2f8", boxShadow: "0 4px 10px rgba(0,0,0,0.1)" } }}>Cancel</Button> 
            <Button type="submit" variant="contained" sx={{ borderRadius: 2, fontWeight: "900", textTransform: "none", px: 3, py: 1, boxShadow: "0 2px 8px rgba(190, 24, 93,0.3)", background: "linear-gradient(135deg, #be185d 0%, #9d174d 100%)", color: "#ffffff", "&:hover": { background: "linear-gradient(135deg, #9d174d 0%, #be185d 100%)", boxShadow: "0 4px 14px rgba(190, 24, 93,0.4)" } }}>Confirm Registration</Button> 
          </DialogActions> 
        </form> 
      </Dialog>
      ...
      >
        <DialogContent sx={{ p: 4, textAlign: 'center' }}>
          ...
          <Paper elevation={0} sx={{ p: 2.5, bgcolor: "#fdf2f8", border: "1px solid #fce7f3", boxShadow: "0 2px 8px rgba(190, 24, 93,0.1)", borderRadius: 2, mb: 4, textAlign: "left" }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}> 
            <Button fullWidth variant="contained" onClick={() => { onCloseRegSuccess(); onDonateClick(); }} startIcon={<FavoriteIcon />} sx={{ py: 1.6, borderRadius: 2, fontWeight: "900", textTransform: "uppercase", letterSpacing: "1px", fontSize: "0.95rem", boxShadow: "0 2px 8px rgba(190, 24, 93,0.3)", bgcolor: "#be185d", color: "white", "&:hover": { bgcolor: "#9d174d", boxShadow: "0 4px 14px rgba(190, 24, 93,0.4)" } }}>Donate Now</Button> 
            <Button fullWidth variant="outlined" onClick={onCloseRegSuccess} sx={{ py: 1.4, borderRadius: 2, fontWeight: "900", textTransform: "none", fontSize: "0.9rem", border: "1px solid #e2e8f0", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", color: "#1e293b", bgcolor: "white", "&:hover": { bgcolor: "#fdf2f8", boxShadow: "0 4px 10px rgba(0,0,0,0.1)" } }}>Close</Button> 
          </Box> 
        </DialogContent> 
      </Dialog>
    </>
