    ...
    <>
      ...
      >
        <form onSubmit={onSubmitRegister}>
          ...
          <DialogActions sx={{ px: 3, pb: 3.5, pt: 1.5, display: "flex", gap: 1.5 }}> 
            ...
            <Button type="submit" variant="contained" sx={{ borderRadius: 2, fontWeight: "900", textTransform: "none", px: 3, py: 1, boxShadow: "0 2px 8px rgba(27, 79, 147,0.3)", background: "linear-gradient(135deg, #1b4f93 0%, #113a70 100%)", color: "#ffffff", "&:hover": { background: "linear-gradient(135deg, #113a70 0%, #1b4f93 100%)", boxShadow: "0 4px 14px rgba(27, 79, 147,0.4)" } }}>Confirm Registration</Button> 
          </DialogActions> 
        </form> 
      </Dialog>
      ...
      >
        <DialogContent sx={{ p: 4, textAlign: 'center' }}>
          ...
          <Paper elevation={0} sx={{ p: 2.5, bgcolor: "#f0f9ff", border: "1px solid #bae6fd", boxShadow: "0 2px 8px rgba(27, 79, 147,0.1)", borderRadius: 2, mb: 4, textAlign: "left" }}>
